...
class Twitter {
    ...
    public function __construct(){
        $config = Config::read('api', TRUE);
        $this->consumer_key = $config['twitter']['consumerkey'];
        $this->consumer_secret = $config['twitter']['consumersecret'];
        ...
        if (!$this->twitterdata) {
            ...
            // Verficamos que la autenticación se haya llevado a cabo
                ...
                // Sino mostramos el error que no retorna
                    ...
                    Flash::error($tmhOAuth->response['error']);
                }
