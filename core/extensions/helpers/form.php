...
class Form
{
    ...
    /**
     * Utilizado para generar los id de los checkbox,
     * lleva un conteo interno
     *
     * @var array
     */
    protected static $_checkbox = array();
    ...
    public static function check($field, $checkValue, $attrs = NULL, $checked = NULL)
    {
        ...
        if(isset(self::$_checkbox[$field])) {
                self::$_checkbox[$field]++;
        } else {
                self::$_checkbox[$field] = 0;
        }
        $id .= self::$_checkbox[$field];
